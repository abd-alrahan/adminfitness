...
class MusclybuildeController extends GetxController {
...
class Musclybuilde extends StatelessWidget {
  Musclybuilde({super.key});

  final MusclybuildeController controller = Get.put(MusclybuildeController());
