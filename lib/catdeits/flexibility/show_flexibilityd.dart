...
class ShowFlexibilityd extends StatelessWidget {
  ShowFlexibilityd({super.key});
        ...
        children: [
          ...
          Center(
            child: BlurContainer(
              ...
              width: 600,
              list: [
                MyText(text: 'Flexibility Diets', fontsize: 40),
                  ...
                  return DropdownButton<int>(
                    ...
                    onChanged: (value) {
                      if (value != null) {
                        ...
                        showDietsController.fetchDietsByDayId(value + 30);
                      }
                    },
                  );
                }),
